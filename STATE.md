...
python3 test_query.py && python3 test_excerpt.py && python3 test_infoq.py \
  && python3 test_speakers.py && python3 test_stem.py && python3 test_fetch_transcripts.py
cd uitest && node run.js                 # nine suites, 183 checks, about four minutes
