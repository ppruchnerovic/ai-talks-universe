---
id: PJOthBhLbao
title: "Unifying AI integration with Model Context Protocol by Christian Tzolov, Dariusz Jędrzejczyk"
...
# Unifying AI integration with Model Context Protocol by Christian Tzolov, Dariusz Jędrzejczyk

**Speaker not identified**

`Devoxx` · `Devoxx` · `2025` · `52 min`

[Watch the recording](https://www.youtube.com/watch?v=PJOthBhLbao) · [Conference site](https://devoxx.com/)
