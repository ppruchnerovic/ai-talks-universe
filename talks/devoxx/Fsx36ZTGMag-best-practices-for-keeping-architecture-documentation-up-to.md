---
id: Fsx36ZTGMag
title: "Best Practices for Keeping Architecture Documentation Up to Date - Falk Sippach"
slug: best-practices-for-keeping-architecture-documentation-up-to
conference: devoxx
...
# Best Practices for Keeping Architecture Documentation Up to Date - Falk Sippach

**Falk Sippach**

`Devoxx` · `Devoxx` · `2025` · `46 min`

[Watch the recording](https://www.youtube.com/watch?v=Fsx36ZTGMag) · [Conference site](https://devoxx.com/)
