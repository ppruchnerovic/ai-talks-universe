---
id: qnyShY9-aKo
title: "USENIX Security '25 - Surviving in Dark Forest: Towards Evading the Attacks from Front-Running Bots"
slug: usenix-security-25-surviving-in-dark-forest-towards-evading
...
video_id: qnyShY9-aKo
url: https://www.youtube.com/watch?v=qnyShY9-aKo
youtube_url: https://www.youtube.com/watch?v=qnyShY9-aKo
...
`USENIX Security Symposium` · `USENIX Security` · `2025` · `21 min`

`#usenix` `#technology` `#conference` `#open access`

[Watch the recording](https://www.youtube.com/watch?v=qnyShY9-aKo) · [Conference site](https://www.usenix.org/conference/usenixsecurity26)
