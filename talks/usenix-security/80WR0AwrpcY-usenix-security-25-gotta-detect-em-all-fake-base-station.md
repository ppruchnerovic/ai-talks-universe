---
id: 80WR0AwrpcY
title: "USENIX Security '25 - Gotta Detect 'Em All: Fake Base Station and Multi-Step Attack Detection..."
...
channel: "USENIX"
duration_min: 11
published_at: 2025-10-30T20:01:55Z
video_id: 80WR0AwrpcY
...
`USENIX Security Symposium` · `USENIX` · `2025` · `11 min`

`#usenix` `#technology` `#conference` `#open access`

[Watch the recording](https://www.youtube.com/watch?v=80WR0AwrpcY) · [Conference site](https://www.usenix.org/conference/usenixsecurity26)
