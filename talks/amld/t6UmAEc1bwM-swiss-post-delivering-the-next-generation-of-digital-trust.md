---
id: t6UmAEc1bwM
title: "Swiss Post - Delivering the Next Generation of Digital Trust and... | Laetitia Henriot Arsever"
slug: swiss-post-delivering-the-next-generation-of-digital-trust
conference: amld
...
youtube_url: https://www.youtube.com/watch?v=t6UmAEc1bwM
tags: ["AMLD", "Machine Learning", "ML", "Artificial Intelligence", "AI", "Applied Machine Learning Days", "EPFL", "AMLD EPFL", "AMLDEPFL22"]
transcript: false
---

# Swiss Post - Delivering the Next Generation of Digital Trust and... | Laetitia Henriot Arsever

**Swiss Post, Laetitia Henriot Arsever**

`Applied Machine Learning Days` · `AMLD` · `2022` · `9 min`

`#AMLD` `#Machine Learning` `#ML` `#Artificial Intelligence` `#AI` `#Applied Machine Learning Days` `#EPFL` `#AMLD EPFL` `#AMLDEPFL22`

[Watch the recording](https://www.youtube.com/watch?v=t6UmAEc1bwM) · [Conference site](https://appliedmldays.org/)

## Description

AMLD Keynote Session
"Swiss Post - Delivering the Next Generation of Digital Trust and Data Insight to service Switzerland and its Citizens"
