---
id: gljTUXB6Tv4
title: "Panel Discussion: Law & Policy | Suzanne Vergnolle, Michael Veale, Belén Arribas & Paul Nemitz"
slug: panel-discussion-law-policy-suzanne-vergnolle-michael-veale
conference: amld
...
youtube_url: https://www.youtube.com/watch?v=gljTUXB6Tv4
tags: ["AMLD", "Machine Learning", "ML", "Artificial Intelligence", "AI", "Applied Machine Learning Days", "EPFL", "AMLD EPFL", "AMLDEPFL22"]
transcript: false
---

# Panel Discussion: Law & Policy | Suzanne Vergnolle, Michael Veale, Belén Arribas & Paul Nemitz

**Suzanne Vergnolle**

`Applied Machine Learning Days` · `AMLD` · `2022` · `91 min`

`#AMLD` `#Machine Learning` `#ML` `#Artificial Intelligence` `#AI` `#Applied Machine Learning Days` `#EPFL` `#AMLD EPFL` `#AMLDEPFL22`

[Watch the recording](https://www.youtube.com/watch?v=gljTUXB6Tv4) · [Conference site](https://appliedmldays.org/)

## Description

AI & Regulation
"Panel Discussion: Law & Policy"
Suzanne Vergnolle, Michael Veale, Belén Arribas & Paul Nemitz
