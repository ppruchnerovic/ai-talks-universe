---
id: Uwr4w4-AxXM
title: "GPTs are GPTs: An Early Look at the Labor Market Impact Potential of LLMs | Daniel Rock"
...
url: https://www.youtube.com/watch?v=Uwr4w4-AxXM
youtube_url: https://www.youtube.com/watch?v=Uwr4w4-AxXM
...
`Applied Machine Learning Days` · `AMLD` · `2023` · `25 min`

`#AMLD` `#Machine Learning` `#ML` `#Artificial Intelligence` `#AI` `#Applied Machine Learning Days` `#EPFL` `#AMLD EPFL` `#AMLDEPFL22`

[Watch the recording](https://www.youtube.com/watch?v=Uwr4w4-AxXM) · [Conference site](https://appliedmldays.org/)

## Description

GPTs are GPTs: An Early Look at the Labor Market Impact Potential of Large Language Models | Daniel Rock is an Assistant Professor of Operations, Information, and Decisions at the Wharton School of the University of Pennsylvania.
