---
id: R3K7h_v6wZY
title: "Monitoring the Missing Migrants | Andrea Garcia Borja & Jenny Paola Yela Bello"
slug: monitoring-the-missing-migrants-andrea-garcia-borja-jenny
conference: amld
...
duration_min: 56
published_at: 2022-05-06T07:41:16Z
video_id: R3K7h_v6wZY
youtube_url: https://www.youtube.com/watch?v=R3K7h_v6wZY
tags: ["AMLD", "Machine Learning", "ML", "Artificial Intelligence", "AI", "Applied Machine Learning Days", "EPFL", "AMLD EPFL", "AMLDEPFL22"]
transcript: false
---

# Monitoring the Missing Migrants | Andrea Garcia Borja & Jenny Paola Yela Bello

**Speaker not identified**

`Applied Machine Learning Days` · `AMLD` · `2022` · `56 min`

`#AMLD` `#Machine Learning` `#ML` `#Artificial Intelligence` `#AI` `#Applied Machine Learning Days` `#EPFL` `#AMLD EPFL` `#AMLDEPFL22`

[Watch the recording](https://www.youtube.com/watch?v=R3K7h_v6wZY) · [Conference site](https://appliedmldays.org/)

## Description

Using AI to track missing migrants worldwide
"Monitoring the Missing Migrants"
Andrea Garcia Borja & Jenny Paola Yela Bello
