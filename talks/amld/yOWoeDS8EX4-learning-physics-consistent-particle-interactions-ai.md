---
id: yOWoeDS8EX4
title: "Learning Physics-Consistent Particle Interactions | AI & Engineering | Zhichao Han"
slug: learning-physics-consistent-particle-interactions-ai
conference: amld
conference_name: "Applied Machine Learning Days"
category: "AI engineering & agents"
edition: "AMLD"
year: 2022
speakers: ["Zhichao Han"]
channel: "AMLD Intelligence Summit"
duration_min: 7
published_at: 2022-05-02T08:19:25Z
video_id: yOWoeDS8EX4
youtube_url: https://www.youtube.com/watch?v=yOWoeDS8EX4
tags: ["AMLD", "Machine Learning", "ML", "Artificial Intelligence", "AI", "Applied Machine Learning Days", "EPFL", "AMLD EPFL", "AMLDEPFL22"]
transcript: false
---

# Learning Physics-Consistent Particle Interactions | AI & Engineering | Zhichao Han

**Zhichao Han**

`Applied Machine Learning Days` · `AMLD` · `2022` · `7 min`

`#AMLD` `#Machine Learning` `#ML` `#Artificial Intelligence` `#AI` `#Applied Machine Learning Days` `#EPFL` `#AMLD EPFL` `#AMLDEPFL22`

[Watch the recording](https://www.youtube.com/watch?v=yOWoeDS8EX4) · [Conference site](https://appliedmldays.org/)
