---
id: wAJaaSz1P4E
title: "Panel discussion #2 | with Armand Joulin, Neil Houlsby, Ani Kembhavi and Fei Xia"
...
duration_min: 31
published_at: 2023-10-05T16:19:38Z
video_id: wAJaaSz1P4E
...
# Panel discussion #2 | with Armand Joulin, Neil Houlsby, Ani Kembhavi and Fei Xia

**Speaker not identified**

`Applied Machine Learning Days` · `AMLD` · `2023` · `31 min`

`#AMLD` `#Machine Learning` `#ML` `#Artificial Intelligence` `#AI` `#Applied Machine Learning Days` `#EPFL` `#AMLD EPFL` `#AMLDEPFL22`

[Watch the recording](https://www.youtube.com/watch?v=wAJaaSz1P4E) · [Conference site](https://appliedmldays.org/)

## Description

Armand Joulin is a Research Scientist former Director of EMEA FAIR Meta

Neil Houlsby is a Research Scientist, Google Brain

Aniruddha Kembhavi is a Senior Director of Computer Vision at the Allen Institute for AI (AI2)

Fei Xia is a Research Scientist, Google DeepMind
