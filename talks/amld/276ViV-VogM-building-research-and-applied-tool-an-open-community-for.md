---
id: 276ViV-VogM
title: "Building Research and Applied Tool: an Open Community for Healthcare NLP | Thomas Wolf"
slug: building-research-and-applied-tool-an-open-community-for
conference: amld
...
channel: null
duration_min: 22
published_at: 2022-04-29T08:05:50Z
video_id: 276ViV-VogM
youtube_url: https://www.youtube.com/watch?v=276ViV-VogM
tags: ["AMLD", "Machine Learning", "ML", "Artificial Intelligence", "AI", "Applied Machine Learning Days", "EPFL", "AMLD EPFL", "AMLDEPFL22"]
transcript: false
---

# Building Research and Applied Tool: an Open Community for Healthcare NLP | Thomas Wolf

**Thomas Wolf**

`Applied Machine Learning Days` · `AMLD` · `2022` · `22 min`

`#AMLD` `#Machine Learning` `#ML` `#Artificial Intelligence` `#AI` `#Applied Machine Learning Days` `#EPFL` `#AMLD EPFL` `#AMLDEPFL22`

[Watch the recording](https://www.youtube.com/watch?v=276ViV-VogM) · [Conference site](https://appliedmldays.org/)

## Description

AI & Healthcare
"Building Research and Applied Tool: an Open Community for Healthcare NLP"
Thomas Wolf
