---
id: eYst8JqSxjE
title: "Set the course: Crafting a legal and regulatory landscape for AI | Roger Dubach"
...
url: https://www.youtube.com/watch?v=eYst8JqSxjE
youtube_url: https://www.youtube.com/watch?v=eYst8JqSxjE
tags: ["AMLD", "Machine Learning", "ML", "Artificial Intelligence", "AI", "Applied Machine Learning Days", "EPFL", "AMLD EPFL", "AMLDEPFL22"]
topics: ["Governance, ethics & regulation", "Science, healthcare & applied ML"]
transcript: false
---

# Set the course: Crafting a legal and regulatory landscape for AI | Roger Dubach

**Roger Dubach**

`Applied Machine Learning Days` · `AMLD` · `2023` · `19 min`

`#AMLD` `#Machine Learning` `#ML` `#Artificial Intelligence` `#AI` `#Applied Machine Learning Days` `#EPFL` `#AMLD EPFL` `#AMLDEPFL22`

[Watch the recording](https://www.youtube.com/watch?v=eYst8JqSxjE) · [Conference site](https://appliedmldays.org/)
...
AMLD Website: https://www.appliedmldays.orgg
