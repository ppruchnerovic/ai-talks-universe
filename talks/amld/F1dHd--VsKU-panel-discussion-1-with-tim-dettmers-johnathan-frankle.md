---
id: F1dHd--VsKU
title: "Panel discussion #1 | with Tim Dettmers, Johnathan Frankle, Julien Launay and Ce Zhang"
...
channel: null
duration_min: 38
published_at: 2023-10-05T16:19:19Z
video_id: F1dHd--VsKU
...
`Applied Machine Learning Days` · `AMLD` · `2023` · `38 min`

`#AMLD` `#Machine Learning` `#ML` `#Artificial Intelligence` `#AI` `#Applied Machine Learning Days` `#EPFL` `#AMLD EPFL` `#AMLDEPFL22`

[Watch the recording](https://www.youtube.com/watch?v=F1dHd--VsKU) · [Conference site](https://appliedmldays.org/)

## Description

Tim Dettmers is a PhD Student, University of Washington

Julien Launay is a Extreme-scale lead, Hugging Face

Ce Zhang is an Associate Professor in Computer Science at ETH Zürich.
