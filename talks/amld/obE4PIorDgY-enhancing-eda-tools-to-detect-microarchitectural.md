---
id: obE4PIorDgY
title: "Enhancing EDA Tools to Detect Microarchitectural Vulnerabilities | Flavien Solt"
slug: enhancing-eda-tools-to-detect-microarchitectural
conference: amld
...
youtube_url: https://www.youtube.com/watch?v=obE4PIorDgY
tags: []
transcript: false
---

# Enhancing EDA Tools to Detect Microarchitectural Vulnerabilities | Flavien Solt

**Flavien Solt**

`Applied Machine Learning Days` · `AMLD` · `2022` · `19 min`

[Watch the recording](https://www.youtube.com/watch?v=obE4PIorDgY) · [Conference site](https://appliedmldays.org/)
