---
id: ZgkJ_TD_CRI
title: "Flow-based 3D Avatar Generation from Sparse Observations | Sadegh Aliakbarian"
slug: flow-based-3d-avatar-generation-from-sparse-observations
conference: amld
...
youtube_url: https://www.youtube.com/watch?v=ZgkJ_TD_CRI
tags: []
transcript: false
---

# Flow-based 3D Avatar Generation from Sparse Observations | Sadegh Aliakbarian

**Sadegh Aliakbarian**

`Applied Machine Learning Days` · `AMLD` · `2022` · `19 min`

[Watch the recording](https://www.youtube.com/watch?v=ZgkJ_TD_CRI) · [Conference site](https://appliedmldays.org/)
