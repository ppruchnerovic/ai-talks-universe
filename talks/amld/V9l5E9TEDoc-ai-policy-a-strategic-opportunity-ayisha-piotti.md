---
id: V9l5E9TEDoc
title: "AI Policy – a strategic opportunity | Ayisha Piotti"
...
url: https://www.youtube.com/watch?v=V9l5E9TEDoc
youtube_url: https://www.youtube.com/watch?v=V9l5E9TEDoc
tags: ["AMLD", "Machine Learning", "ML", "Artificial Intelligence", "AI", "Applied Machine Learning Days", "EPFL", "AMLD EPFL", "AMLDEPFL22"]
topics: ["Enterprise adoption & strategy", "Governance, ethics & regulation"]
transcript: false
---

# AI Policy – a strategic opportunity | Ayisha Piotti

**Ayisha Piotti**

`Applied Machine Learning Days` · `AMLD` · `2023` · `21 min`

`#AMLD` `#Machine Learning` `#ML` `#Artificial Intelligence` `#AI` `#Applied Machine Learning Days` `#EPFL` `#AMLD EPFL` `#AMLDEPFL22`

[Watch the recording](https://www.youtube.com/watch?v=V9l5E9TEDoc) · [Conference site](https://appliedmldays.org/)
