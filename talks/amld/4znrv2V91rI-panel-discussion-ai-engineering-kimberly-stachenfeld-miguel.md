---
id: 4znrv2V91rI
title: "Panel Discussion | AI & Engineering | Kimberly Stachenfeld, Miguel A. Bessa & Olga Fink"
slug: panel-discussion-ai-engineering-kimberly-stachenfeld-miguel
conference: amld
...
youtube_url: https://www.youtube.com/watch?v=4znrv2V91rI
tags: ["AMLD", "Machine Learning", "ML", "Artificial Intelligence", "AI", "Applied Machine Learning Days", "EPFL", "AMLD EPFL", "AMLDEPFL22"]
transcript: false
---

# Panel Discussion | AI & Engineering | Kimberly Stachenfeld, Miguel A. Bessa & Olga Fink

**Kimberly Stachenfeld**

`Applied Machine Learning Days` · `AMLD` · `2022` · `20 min`

`#AMLD` `#Machine Learning` `#ML` `#Artificial Intelligence` `#AI` `#Applied Machine Learning Days` `#EPFL` `#AMLD EPFL` `#AMLDEPFL22`

[Watch the recording](https://www.youtube.com/watch?v=4znrv2V91rI) · [Conference site](https://appliedmldays.org/)

## Description

AI & Engineering
"Panel Discussion"
Kimberly Stachenfeld, Miguel A. Bessa & Olga Fink
