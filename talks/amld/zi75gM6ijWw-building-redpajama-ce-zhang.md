---
id: zi75gM6ijWw
title: "Building RedPajama | Ce Zhang"
...
duration_min: 27
published_at: 2023-10-05T16:19:16Z
video_id: zi75gM6ijWw
...
# Building RedPajama | Ce Zhang

**Ce Zhang**

`Applied Machine Learning Days` · `AMLD` · `2023` · `27 min`

`#AMLD` `#Machine Learning` `#ML` `#Artificial Intelligence` `#AI` `#Applied Machine Learning Days` `#EPFL` `#AMLD EPFL` `#AMLDEPFL22`

[Watch the recording](https://www.youtube.com/watch?v=zi75gM6ijWw) · [Conference site](https://appliedmldays.org/)
