---
id: MtamrtfVuxQ
title: "Introduction | Jan Kerschgens"
slug: introduction-jan-kerschgens
conference: amld
...
url: https://www.youtube.com/watch?v=MtamrtfVuxQ
youtube_url: https://www.youtube.com/watch?v=MtamrtfVuxQ
tags: ["AMLD", "Machine Learning", "ML", "Artificial Intelligence", "AI", "Applied Machine Learning Days", "EPFL", "AMLD EPFL", "AMLDEPFL22"]
topics: []
transcript: false
---

# Introduction | Jan Kerschgens

**Jan Kerschgens**

`Applied Machine Learning Days` · `AMLD` · `2023` · `7 min`

`#AMLD` `#Machine Learning` `#ML` `#Artificial Intelligence` `#AI` `#Applied Machine Learning Days` `#EPFL` `#AMLD EPFL` `#AMLDEPFL22`

[Watch the recording](https://www.youtube.com/watch?v=MtamrtfVuxQ) · [Conference site](https://appliedmldays.org/)

## Description

Dr. Jan Kerschgens is a Executive Director, Center for Intelligent Systems (CIS)
