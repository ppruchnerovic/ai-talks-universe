---
id: lU6KrxFkEpY
title: "AI in the machine tool industry: opportunities & challenges | Adina Dorthe"
slug: ai-in-the-machine-tool-industry-opportunities-challenges
conference: amld
...
url: https://www.youtube.com/watch?v=lU6KrxFkEpY
youtube_url: https://www.youtube.com/watch?v=lU6KrxFkEpY
tags: ["AMLD", "Machine Learning", "ML", "Artificial Intelligence", "AI", "Applied Machine Learning Days", "EPFL", "AMLD EPFL", "AMLDEPFL22"]
transcript: false
---

# AI in the machine tool industry: opportunities & challenges | Adina Dorthe

**Adina Dorthe**

`Applied Machine Learning Days` · `AMLD` · `2023` · `20 min`

`#AMLD` `#Machine Learning` `#ML` `#Artificial Intelligence` `#AI` `#Applied Machine Learning Days` `#EPFL` `#AMLD EPFL` `#AMLDEPFL22`

[Watch the recording](https://www.youtube.com/watch?v=lU6KrxFkEpY) · [Conference site](https://appliedmldays.org/)

## Description

Adina Dorthe is a Head of Innovation & R&D Digital Business Unit, Georg Fischer
