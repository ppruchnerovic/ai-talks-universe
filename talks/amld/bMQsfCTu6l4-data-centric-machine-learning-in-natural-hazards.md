---
id: bMQsfCTu6l4
title: "Data-Centric Machine Learning in Natural Hazards Engineering | AI & Engineering | Nenad Bijelić"
slug: data-centric-machine-learning-in-natural-hazards
conference: amld
...
duration_min: 5
published_at: 2022-04-22T14:28:22Z
video_id: bMQsfCTu6l4
youtube_url: https://www.youtube.com/watch?v=bMQsfCTu6l4
tags: ["AMLD", "Machine Learning", "ML", "Artificial Intelligence", "AI", "Applied Machine Learning Days", "EPFL", "AMLD EPFL", "AMLDEPFL22"]
transcript: false
---

# Data-Centric Machine Learning in Natural Hazards Engineering | AI & Engineering | Nenad Bijelić

**Speaker not identified**

`Applied Machine Learning Days` · `AMLD` · `2022` · `5 min`

`#AMLD` `#Machine Learning` `#ML` `#Artificial Intelligence` `#AI` `#Applied Machine Learning Days` `#EPFL` `#AMLD EPFL` `#AMLDEPFL22`

[Watch the recording](https://www.youtube.com/watch?v=bMQsfCTu6l4) · [Conference site](https://appliedmldays.org/)
