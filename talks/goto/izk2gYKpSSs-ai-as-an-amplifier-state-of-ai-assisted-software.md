---
id: izk2gYKpSSs
title: "AI as an Amplifier: State of AI-Assisted Software Development • Nathen Harvey • GOTO 2026"
...
# AI as an Amplifier: State of AI-Assisted Software Development • Nathen Harvey • GOTO 2026

**Nathen Harvey**

`GOTO Conferences` · `GOTO` · `2026` · `56 min`

`#GOTO` `#GOTOcon` `#GOTO Conference` `#GOTO (Software Conference)` `#Videos for Developers` `#Computer Science` `#Programming` `#Software Engineering` `#GOTOpia` `#Tech` `#Software Development` `#Tech Channel` `#Tech Conference` `#Today in Tech` `#GOTOchgo` `#GOTO Chicago` `#DORA` `#DORA Metrics` `#Nathen Harvey` `#AI Adoption` `#DevOps` `#Accelerate` `#Change` `#Software Delivery` `#CI/CD` `#Continuous Delivery` `#Continuous Integration`

[Watch the recording](https://www.youtube.com/watch?v=izk2gYKpSSs) · [Conference site](https://gotopia.tech/)

## Description

This presentation was recorded at GOTO Chicago 2026. #GOTOcon #GOTOchgo

Nathen Harvey - DORA Lead, Product Manager at Google Cloud & Author @NathenHarvey
