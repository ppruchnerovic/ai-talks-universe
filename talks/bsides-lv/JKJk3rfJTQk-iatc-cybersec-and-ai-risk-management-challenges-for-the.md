---
id: JKJk3rfJTQk
title: "IATC - Cybersec and AI Risk Management Challenges for the Next Generation of Public Safety Systems"
...
`BSides Las Vegas` · `BSides Las Vegas` · `2024` · `35 min`

`#HPMCNK`

[Watch the recording](https://www.youtube.com/watch?v=JKJk3rfJTQk) · [Conference site](https://bsideslv.org/)

## Description

Cybersecurity and Artificial Intelligence Risk Management Challenges for the Next Generation of Public Safety Systems (full title included here since there's a 100 character title limit)

I Am The Cavalry, Tue, Aug 6, 13:00 - Tue, Aug 6, 13:45 CDT
