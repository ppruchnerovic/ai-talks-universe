...
`WeAreDevelopers World Congress` · `World Congress 2026` · `2026` · `25 min`

`#AI Engineering` `#AI Coding Assistants` `#AI Standards` `#Anthropic` `#Agents` `#Case Study` `#Claude` `#Copilot` `#DeepSeek` `#Developer Experience (DevEx)` `#GitHub` `#GitLab` `#Heroku` `#Jira` `#OpenAI` `#Product Management` `#Project Management` `#Startups` `#VS Code`

[Watch the recording](https://www.youtube.com/watch?v=ADcdC7L8VkM) · [Conference site](https://www.wearedevelopers.com/en)
...
*2,881 words · source: yt (en, exact timings)*
