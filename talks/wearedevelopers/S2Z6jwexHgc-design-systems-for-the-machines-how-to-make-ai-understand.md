...
`#Frontend, Web & Mobile` `#Accessibility` `#AI Models` `#Automation` `#Design Systems` `#Large Language Models (LLMs)` `#Productivity`

[Watch the recording](https://www.youtube.com/watch?v=S2Z6jwexHgc) · [Conference site](https://www.wearedevelopers.com/en)
...
*2,773 words · source: yt (en, exact timings)*
