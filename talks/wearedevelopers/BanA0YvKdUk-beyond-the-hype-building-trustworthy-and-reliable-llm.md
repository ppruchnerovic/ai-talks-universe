---
id: BanA0YvKdUk
title: "Beyond the Hype: Building Trustworthy and Reliable LLM Applications with Guardrails - Alex Soto"
...
# Beyond the Hype: Building Trustworthy and Reliable LLM Applications with Guardrails - Alex Soto
...
[Watch the recording](https://www.youtube.com/watch?v=BanA0YvKdUk) · [Conference site](https://www.wearedevelopers.com/en)

## Description

Discover how to secure Generative AI apps against data leaks, hostile prompts, and policy risks. Learn practical safety practices with tools like LangChain4J, Hugging Face, and OpenAI—featuring real-world examples and live demos.
