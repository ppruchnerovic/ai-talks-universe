...
`#Quality & Reliability` `#AppSec` `#Agents` `#DevSecOps` `#Security` `#Threat Modelling`

[Watch the recording](https://www.youtube.com/watch?v=pDhlie4JR0I) · [Conference site](https://www.wearedevelopers.com/en)
...
*671 words · source: yt (en, exact timings)*
