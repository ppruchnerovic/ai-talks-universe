...
`#Developer Experience` `#Clean Code` `#Developer Experience (DevEx)` `#Legacy` `#Motivation` `#People & Culture`

[Watch the recording](https://www.youtube.com/watch?v=RwSfrCDMdqo) · [Conference site](https://www.wearedevelopers.com/en)
...
*1,308 words · source: yt (en, exact timings)*
