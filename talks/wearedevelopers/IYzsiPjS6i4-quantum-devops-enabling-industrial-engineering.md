...
`#Emerging Technologies` `#DevOps` `#Integration` `#NVIDIA` `#Quantum` `#Systems Programming`

[Watch the recording](https://www.youtube.com/watch?v=IYzsiPjS6i4) · [Conference site](https://www.wearedevelopers.com/en)
