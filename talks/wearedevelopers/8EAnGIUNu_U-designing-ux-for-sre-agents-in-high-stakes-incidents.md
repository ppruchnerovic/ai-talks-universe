...
`WeAreDevelopers World Congress` · `World Congress 2026` · `2026` · `7 min`

`#AI Agents` `#Agentic AI` `#Site Reliability Engineering (SRE)` `#UI/UX`

[Watch the recording](https://www.youtube.com/watch?v=8EAnGIUNu_U) · [Conference site](https://www.wearedevelopers.com/en)
...
*1,040 words · source: yt (en, exact timings)*
