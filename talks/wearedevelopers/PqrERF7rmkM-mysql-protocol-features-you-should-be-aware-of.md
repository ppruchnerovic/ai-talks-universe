...
`#Data & Databases` `#Databases` `#MySQL` `#Networking` `#SQL`

[Watch the recording](https://www.youtube.com/watch?v=PqrERF7rmkM) · [Conference site](https://www.wearedevelopers.com/en)
...
*1,606 words · source: yt (en, exact timings)*
