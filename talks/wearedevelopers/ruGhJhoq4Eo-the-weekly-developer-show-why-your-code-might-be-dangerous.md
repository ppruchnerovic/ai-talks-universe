---
id: ruGhJhoq4Eo
title: "The weekly developer show: Why Your Code Might Be Dangerous - A Developer's Guide to AI Security"
...
# The weekly developer show: Why Your Code Might Be Dangerous - A Developer's Guide to AI Security

**Speaker not identified**

`WeAreDevelopers World Congress` · `WeAreDevelopers` · `2025` · `56 min`

`#conference` `#congress` `#Europe` `#tech` `#technology` `#IT` `#people` `#code` `#future` `#coding` `#programming` `#programmer` `#software` `#engineer` `#developer` `#developing` `#WeAreDevs` `#WeAreDevelopers` `#wearedevelopers` `#wearedevs` `#wearedeveloperslive` `#tech talks` `#security` `#AI` `#cybersecurity` `#developers` `#web development` `#chatgpt` `#data breaches` `#api keys` `#regex` `#open source` `#dev advocacy` `#javascript` `#vibe coding` `#LLMs` `#developer podcast` `#dev tips` `#cloud security`

[Watch the recording](https://www.youtube.com/watch?v=ruGhJhoq4Eo) · [Conference site](https://www.wearedevelopers.com/en)

## Description

Join us for a high-energy episode of WeAreDevelopers Live! This week, we’re joined by Ramona Schwering, Developer Advocate Auth0 by Okta, to dive into the world of security vulnerabilities, AI-generated threats, regex nightmares, and the surprising risks of vibe coding. We also discuss leaked API keys, the dangers of overtrusting LLMs like ChatGPT, real-world horror stories, and how to stay sane (and safe) in the rapidly evolving tech landscape.

00:00 Introduction
01:31 Security Insights
02:39 AI Threats
06:15 Data Protection
12:23 Code Safety
24:09 DDoS Concerns
26:52 Cloud Security
36:38 Chrome Antitrust
42:29 Conclusion
