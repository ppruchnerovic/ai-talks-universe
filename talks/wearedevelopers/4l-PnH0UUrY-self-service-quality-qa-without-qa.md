...
`#Quality & Reliability` `#AI Models` `#Quality Assurance (QA)` `#Testing`

[Watch the recording](https://www.youtube.com/watch?v=4l-PnH0UUrY) · [Conference site](https://www.wearedevelopers.com/en)
...
*3,151 words · source: yt (en, exact timings)*
