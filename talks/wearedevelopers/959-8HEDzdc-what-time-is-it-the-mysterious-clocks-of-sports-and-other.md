...
`#Data & Databases` `#Data` `#Data Pipelines` `#Data Science`

[Watch the recording](https://www.youtube.com/watch?v=959-8HEDzdc) · [Conference site](https://www.wearedevelopers.com/en)
...
*1,979 words · source: yt (en, exact timings)*
