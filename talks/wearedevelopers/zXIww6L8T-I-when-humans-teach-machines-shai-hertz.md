---
id: zXIww6L8T-I
title: "When humans teach machines | Shai Hertz"
slug: when-humans-teach-machines-shai-hertz
...
video_id: zXIww6L8T-I
youtube_url: https://www.youtube.com/watch?v=zXIww6L8T-I
tags: ["conference", "congress", "Europe", "tech", "technology", "IT", "people", "code", "future", "coding", "programming", "programmer", "engineer", "developer", "developing", "WeAreDevs", "WeAreDevelopers", "AI", "Artificial intelligence"]
transcript: false
---

# When humans teach machines | Shai Hertz

**Shai Hertz**

`WeAreDevelopers World Congress` · `WeAreDevelopers` · `2018` · `31 min`

`#conference` `#congress` `#Europe` `#tech` `#technology` `#IT` `#people` `#code` `#future` `#coding` `#programming` `#programmer` `#engineer` `#developer` `#developing` `#WeAreDevs` `#WeAreDevelopers` `#AI` `#Artificial intelligence`

[Watch the recording](https://www.youtube.com/watch?v=zXIww6L8T-I) · [Conference site](https://www.wearedevelopers.com/en)
