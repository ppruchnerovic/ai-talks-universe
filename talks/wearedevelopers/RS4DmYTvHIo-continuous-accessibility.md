...
`#Frontend, Web & Mobile` `#Accessibility` `#CI/CD` `#Cypress` `#Playwright` `#Testing` `#TypeScript`

[Watch the recording](https://www.youtube.com/watch?v=RS4DmYTvHIo) · [Conference site](https://www.wearedevelopers.com/en)
...
*1,612 words · source: yt (de, exact timings)*
