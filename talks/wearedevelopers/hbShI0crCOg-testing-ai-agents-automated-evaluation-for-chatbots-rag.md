...
`WeAreDevelopers World Congress` · `World Congress 2026` · `2026` · `31 min`

`#AI Agents` `#AI Models` `#AI Standards` `#Agentic AI` `#Fine-Tuning` `#PyTest` `#Python` `#Retrieval-Augmented Generation (RAG)` `#Unit Testing`

[Watch the recording](https://www.youtube.com/watch?v=hbShI0crCOg) · [Conference site](https://www.wearedevelopers.com/en)
...
*1,610 words · source: yt (de, exact timings)*
