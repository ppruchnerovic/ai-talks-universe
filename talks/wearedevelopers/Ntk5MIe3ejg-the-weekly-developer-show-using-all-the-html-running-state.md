---
id: Ntk5MIe3ejg
title: "The weekly developer show: Using all the HTML, Running State of the Browser, \"Modern\" is rubbish"
slug: the-weekly-developer-show-using-all-the-html-running-state
...
channel: null
duration_min: 67
published_at: 2025-02-19T12:16:47Z
video_id: Ntk5MIe3ejg
...
# The weekly developer show: Using all the HTML, Running State of the Browser, "Modern" is rubbish

**Speaker not identified**

`WeAreDevelopers World Congress` · `WeAreDevelopers` · `2025` · `67 min`
...
[Watch the recording](https://www.youtube.com/watch?v=Ntk5MIe3ejg) · [Conference site](https://www.wearedevelopers.com/en)

## Description

Join us every Wednesday from 12:30 to 13:30 CET for WeAreDevelopers LIVE—your go-to online tech talk where we dive into the latest in software development, explore new tools, share pro tips, and chat with industry experts. Plus, it's all live, so you can jump in and ask your questions in real time!

🔥 This Week's Highlights:
💡 Does AI create illiterate developers?
🖥️ Using all the HTML
🌍 Running State of the Browser
♻️ "Modern" is rubbish

🎙️ Special Guest: David Letorey

Don't miss out—grab a coffee ☕, tune in, and be part of the conversation!
