...
`#Emerging Technologies` `#Edge AI` `#Internet of Things (IoT)` `#Observability` `#Raspberry Pi` `#Startups`

[Watch the recording](https://www.youtube.com/watch?v=gwSsWmPKdTU) · [Conference site](https://www.wearedevelopers.com/en)
