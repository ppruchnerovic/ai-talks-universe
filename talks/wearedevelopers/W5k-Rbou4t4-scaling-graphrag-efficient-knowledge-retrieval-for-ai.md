...
`#AI Engineering` `#Agentic AI` `#Retrieval-Augmented Generation (RAG)`

[Watch the recording](https://www.youtube.com/watch?v=W5k-Rbou4t4) · [Conference site](https://www.wearedevelopers.com/en)
...
*2,816 words · source: yt (en, exact timings)*
