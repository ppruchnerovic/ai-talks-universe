...
`WeAreDevelopers World Congress` · `World Congress 2026` · `2026` · `20 min`

`#Frontend, Web & Mobile` `#APIs` `#TypeScript`

[Watch the recording](https://www.youtube.com/watch?v=6NC9laD5OHY) · [Conference site](https://www.wearedevelopers.com/en)
...
*1,327 words · source: yt (de, exact timings)*
