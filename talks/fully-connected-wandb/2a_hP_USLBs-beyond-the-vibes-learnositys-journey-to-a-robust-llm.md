---
id: 2a_hP_USLBs
title: "Beyond the vibes: Learnosity’s journey to a robust LLM evaluation framework - FC London '25"
...
`Fully Connected (Weights & Biases)` · `Weights & Biases` · `2025` · `13 min`

[Watch the recording](https://www.youtube.com/watch?v=2a_hP_USLBs) · [Conference site](https://fullyconnected.com/)
