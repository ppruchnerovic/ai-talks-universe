...
channel: "AI Engineer"
duration_min: 24
published_at: 2026-07-23T17:30:06Z
video_id: -I5W5QVAT8E
youtube_url: https://www.youtube.com/watch?v=-I5W5QVAT8E
...
**Notion's Token Town, Sarah Sachs**

`AI Engineer` · `AI Engineer` · `2026` · `24 min`

`#ai` `#ai engineer` `#ai engineering` `#software development` `#tech` `#startups` `#software architecture` `#machine learning`

[Watch the recording](https://www.youtube.com/watch?v=-I5W5QVAT8E) · [Conference site](https://www.ai.engineer/)
