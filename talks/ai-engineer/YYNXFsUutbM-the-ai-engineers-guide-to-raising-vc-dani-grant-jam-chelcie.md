...
youtube_url: https://www.youtube.com/watch?v=YYNXFsUutbM
tags: []
transcript: false
---
...
`AI Engineer` · `AI Engineer` · `2025` · `34 min`

[Watch the recording](https://www.youtube.com/watch?v=YYNXFsUutbM) · [Conference site](https://www.ai.engineer/)
