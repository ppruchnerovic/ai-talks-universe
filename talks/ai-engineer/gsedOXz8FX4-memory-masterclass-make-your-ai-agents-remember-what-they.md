...
youtube_url: https://www.youtube.com/watch?v=gsedOXz8FX4
tags: []
transcript: false
---
...
`AI Engineer` · `AI Engineer` · `2025` · `51 min`

[Watch the recording](https://www.youtube.com/watch?v=gsedOXz8FX4) · [Conference site](https://www.ai.engineer/)
