---
id: iKBR18gxOKI
title: "Hacking a smart home with Garry Kasparov, Avast Security Ambassador"
slug: hacking-a-smart-home-with-garry-kasparov-avast-security
...
channel: null
duration_min: 23
published_at: 2018-11-07T19:48:14Z
video_id: iKBR18gxOKI
youtube_url: https://www.youtube.com/watch?v=iKBR18gxOKI
tags: ["Web Summit", "web summit lisbon", "web summit conference lisbon", "web summit paddy", "web summit portugal", "web summit portugal 2018", "web summit video", "web summit youtube", "Web summit lisboa", "Garry Kasparov", "Ondrej Vlcek", "Vladislav Iliushin", "binate", "binate io", "binate.io", "smart home", "hacking", "hack", "security", "data protection", "avast"]
transcript: false
---
...
`#Web Summit` `#web summit lisbon` `#web summit conference lisbon` `#web summit paddy` `#web summit portugal` `#web summit portugal 2018` `#web summit video` `#web summit youtube` `#Web summit lisboa` `#Garry Kasparov` `#Ondrej Vlcek` `#Vladislav Iliushin` `#binate` `#binate io` `#binate.io` `#smart home` `#hacking` `#hack` `#security` `#data protection` `#avast`

[Watch the recording](https://www.youtube.com/watch?v=iKBR18gxOKI) · [Conference site](https://websummit.com)
