...
`#ARIMA` `#Bayesian statistics` `#Conference` `#JAX` `#Kalman filter` `#PyConDE` `#PyData` `#PyData Berlin` `#PyMC` `#Python` `#Tech Talk` `#forecasting` `#hierarchical models` `#machine learning` `#probabilistic programming` `#state space models` `#statistical modeling` `#time series analysis` `#tutorial`

[Watch the recording](https://www.youtube.com/watch?v=lXU5dr6Lmgo) · [Conference site](https://pydata.org/)
