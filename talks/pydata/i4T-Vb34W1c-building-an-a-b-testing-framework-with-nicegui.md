---
id: i4T-Vb34W1c
title: "Building an A/B Testing Framework with NiceGUI"
...
`#A/B testing` `#Conference` `#FastAPI` `#NiceGUI` `#Plotly` `#PyCon` `#PyConDE` `#PyData` `#Python` `#Pythonic` `#Quasar` `#Tailwind CSS` `#Tech Talk` `#analytics engineering` `#dashboard` `#data visualization` `#internal tools` `#no JavaScript` `#web development`

[Watch the recording](https://www.youtube.com/watch?v=i4T-Vb34W1c) · [Conference site](https://pydata.org/)
