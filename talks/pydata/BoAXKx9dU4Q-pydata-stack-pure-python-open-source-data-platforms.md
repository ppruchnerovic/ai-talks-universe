...
`#Conference` `#DBT` `#Dagster` `#DuckDB` `#ETL pipelines` `#PyConDE` `#PyData` `#Python` `#Tech Talk` `#data engineering` `#data quality` `#data transformation` `#data visualization` `#medallion architecture` `#orchestration` `#schema management`

[Watch the recording](https://www.youtube.com/watch?v=BoAXKx9dU4Q) · [Conference site](https://pydata.org/)
