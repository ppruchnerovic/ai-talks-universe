---
id: 3xE9FscDl3I
title: "Workshop Sessions: Part 1 From Concept to Production - Template for the Entire ML Journey"
...
# Workshop Sessions: Part 1 From Concept to Production - Template for the Entire ML Journey

**Speaker not identified**

`MLOps World / Toronto Machine Learning Summit` · `MLOps World / TMLS` · `2023` · `227 min`

`#machine learning` `#artificial intelligence` `#data science` `#machine learning simplified` `#automated machine learning` `#developers` `#Automated ML` `#ml` `#machine learning operations` `#mlops` `#education` `#mlops community` `#workshop sessions` `#mlops world workshop` `#Template for the Entire ML Journey` `#From Concept to Production` `#Workshop Sessions: Part 1 From Concept to Production - Template for the Entire ML Journey`

[Watch the recording](https://www.youtube.com/watch?v=3xE9FscDl3I) · [Conference site](https://mlopsworld.com/)
