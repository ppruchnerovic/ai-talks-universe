---
id: OhhHm02M0b8
title: "MLOps & Automation Workshop: Bringing ML to Production in a Few Easy Steps"
slug: mlops-automation-workshop-bringing-ml-to-production-in-a
...
video_id: OhhHm02M0b8
youtube_url: https://www.youtube.com/watch?v=OhhHm02M0b8
tags: ["machine learning", "data science", "mlops", "devops", "deep learning research", "ai", "deep learning", "ml", "artificial intelligence", "mlops community", "machine learning engineer", "automated ml", "MLOps & Automation Workshop Bringing ML to Production in a Few Easy Steps", "automation", "workshop", "ml engineering", "machine learning tutorial", "data engineers", "data engineering", "data engineer", "Yaron Haviv", "machine learning projects", "complete machine learning project"]
transcript: false
---
...
`MLOps World / Toronto Machine Learning Summit` · `MLOps World / TMLS` · `2021` · `123 min`

`#machine learning` `#data science` `#mlops` `#devops` `#deep learning research` `#ai` `#deep learning` `#ml` `#artificial intelligence` `#mlops community` `#machine learning engineer` `#automated ml` `#MLOps & Automation Workshop Bringing ML to Production in a Few Easy Steps` `#automation` `#workshop` `#ml engineering` `#machine learning tutorial` `#data engineers` `#data engineering` `#data engineer` `#Yaron Haviv` `#machine learning projects` `#complete machine learning project`

[Watch the recording](https://www.youtube.com/watch?v=OhhHm02M0b8) · [Conference site](https://mlopsworld.com/)
