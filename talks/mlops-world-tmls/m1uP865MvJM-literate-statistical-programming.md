...
slug: literate-statistical-programming
...
channel: null
duration_min: 46
published_at: 2021-06-17T16:00:19Z
video_id: m1uP865MvJM
youtube_url: https://www.youtube.com/watch?v=m1uP865MvJM
tags: ["John Peach", "Literate Statistical Programming", "machine learning", "data science", "mlops", "devops", "deep learning research", "ai", "deep learning", "ml", "artificial intelligence", "mlops community", "machine learning engineer", "automated ml", "ml engineering", "machine learning tutorial", "data engineers", "data engineering", "data engineer", "machine learning models", "Statistical Programming", "statistics", "Programming", "literate"]
transcript: false
---
...
`#John Peach` `#Literate Statistical Programming` `#machine learning` `#data science` `#mlops` `#devops` `#deep learning research` `#ai` `#deep learning` `#ml` `#artificial intelligence` `#mlops community` `#machine learning engineer` `#automated ml` `#ml engineering` `#machine learning tutorial` `#data engineers` `#data engineering` `#data engineer` `#machine learning models` `#Statistical Programming` `#statistics` `#Programming` `#literate`

[Watch the recording](https://www.youtube.com/watch?v=m1uP865MvJM) · [Conference site](https://mlopsworld.com/)
