---
id: PjSav80zPVk
title: "Querying and Seeing Time Series Data within a Self-Organizing Mesh Network"
slug: querying-and-seeing-time-series-data-within-a-self
...
duration_min: 77
published_at: 2021-07-02T16:00:17Z
video_id: PjSav80zPVk
youtube_url: https://www.youtube.com/watch?v=PjSav80zPVk
tags: ["machine learning", "artificial intelligence", "data science", "automated machine learning", "developers", "Automated ML", "machine learning operations", "mlops", "querying and seeing time series data within a self-organizing mesh network", "denise gosnell", "seeing time series data within a self-organizing mesh network", "data scientist", "communication network", "mesh network", "data", "network analysis", "Time Series Data", "Modeling", "Self-Organizing Network", "github", "modeling", "querying", "Seeing Time Series Data"]
transcript: false
---
...
`MLOps World / Toronto Machine Learning Summit` · `MLOps World / TMLS` · `2021` · `77 min`

`#machine learning` `#artificial intelligence` `#data science` `#automated machine learning` `#developers` `#Automated ML` `#machine learning operations` `#mlops` `#querying and seeing time series data within a self-organizing mesh network` `#denise gosnell` `#seeing time series data within a self-organizing mesh network` `#data scientist` `#communication network` `#mesh network` `#data` `#network analysis` `#Time Series Data` `#Modeling` `#Self-Organizing Network` `#github` `#modeling` `#querying` `#Seeing Time Series Data`

[Watch the recording](https://www.youtube.com/watch?v=PjSav80zPVk) · [Conference site](https://mlopsworld.com/)
