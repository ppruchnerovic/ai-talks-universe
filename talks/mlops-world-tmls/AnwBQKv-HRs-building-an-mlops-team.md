...
`MLOps World / Toronto Machine Learning Summit` · `MLOps World / TMLS` · `2024` · `5 min`
...
[Watch the recording](https://www.youtube.com/watch?v=AnwBQKv-HRs) · [Conference site](https://mlopsworld.com/)

## Description

Speaker: Marcelo Litovsky:  Aporia, Director of Sales Engineering
