---
id: luQCLsmuyfA
title: "Holistic Health Metrics of ML Based Product"
slug: holistic-health-metrics-of-ml-based-product
...
channel: null
duration_min: 25
published_at: 2021-06-16T16:00:18Z
video_id: luQCLsmuyfA
youtube_url: https://www.youtube.com/watch?v=luQCLsmuyfA
tags: ["Lina Palianytsia", "Metrics Holistic Health Metrics of ML Based Product", "machine learning", "data science", "mlops", "devops", "deep learning research", "ai", "deep learning", "ml", "artificial intelligence", "mlops community", "machine learning engineer", "automated ml", "ml engineering", "machine learning tutorial", "data engineers", "data engineering", "data engineer", "machine learning models", "ML Product", "Holistic Health Metrics", "ML", "holistic metrics"]
transcript: false
---
...
`#Lina Palianytsia` `#Metrics Holistic Health Metrics of ML Based Product` `#machine learning` `#data science` `#mlops` `#devops` `#deep learning research` `#ai` `#deep learning` `#ml` `#artificial intelligence` `#mlops community` `#machine learning engineer` `#automated ml` `#ml engineering` `#machine learning tutorial` `#data engineers` `#data engineering` `#data engineer` `#machine learning models` `#ML Product` `#Holistic Health Metrics` `#ML` `#holistic metrics`

[Watch the recording](https://www.youtube.com/watch?v=luQCLsmuyfA) · [Conference site](https://mlopsworld.com/)
