---
id: jbFsO66VLLg
title: "MLOps vs ModelOps – What’s the Difference and Why You Should Care"
...
`#machine learning` `#artificial intelligence` `#data science` `#machine learning simplified` `#automated machine learning` `#developers` `#Automated ML` `#ml` `#machine learning operations` `#mlops` `#education` `#mlops community` `#MLOps vs ModelOps – What’s the Difference and Why You Should Care` `#MLOps vs ModelOps` `#modelops` `#mlops world`

[Watch the recording](https://www.youtube.com/watch?v=jbFsO66VLLg) · [Conference site](https://mlopsworld.com/)
