---
id: 9XhgqU--hSs
title: "Machine Learning Simplified from Ideation to Deployment in Minutes with Automated Machine Learning"
slug: machine-learning-simplified-from-ideation-to-deployment-in
...
duration_min: 53
published_at: 2021-05-07T16:00:04Z
video_id: 9XhgqU--hSs
youtube_url: https://www.youtube.com/watch?v=9XhgqU--hSs
tags: ["Machine Learning Simplified from Ideation to Deployment in Minutes with Automated Machine Learning", "machine learning", "artificial intelligence", "data science", "machine learning simplified", "automated machine learning", "executives", "analysts", "engineers", "developers", "Aniththa Umamahesan", "azure machine learning", "azure", "microsoft azure machine learning team", "program manager", "program manager interview", "program manager interview questions", "Automated ML", "ml", "power of AI", "amazon web services", "aws"]
transcript: false
---
...
`MLOps World / Toronto Machine Learning Summit` · `MLOps World / TMLS` · `2021` · `53 min`

`#Machine Learning Simplified from Ideation to Deployment in Minutes with Automated Machine Learning` `#machine learning` `#artificial intelligence` `#data science` `#machine learning simplified` `#automated machine learning` `#executives` `#analysts` `#engineers` `#developers` `#Aniththa Umamahesan` `#azure machine learning` `#azure` `#microsoft azure machine learning team` `#program manager` `#program manager interview` `#program manager interview questions` `#Automated ML` `#ml` `#power of AI` `#amazon web services` `#aws`

[Watch the recording](https://www.youtube.com/watch?v=9XhgqU--hSs) · [Conference site](https://mlopsworld.com/)
