...
slug: securing-the-mcp-ecosystem-production-patterns-for
...
video_id: 8eGmT6fZfGk
url: https://www.youtube.com/watch?v=8eGmT6fZfGk
youtube_url: https://www.youtube.com/watch?v=8eGmT6fZfGk
tags: []
topics: ["Agents & orchestration", "Governance, ethics & regulation", "Security, safety & red teaming"]
transcript: false
---

# Securing the MCP Ecosystem: Production Patterns for Transparency... Lisa Tagliaferri & Trevor Dunlap

**Speaker not identified**

`MCP Dev Summit` · `MCP Dev Summit NA 2026` · `2026` · `20 min`

[Watch the recording](https://www.youtube.com/watch?v=8eGmT6fZfGk) · [Conference site](https://events.linuxfoundation.org/mcp-dev-summit-north-america/)
