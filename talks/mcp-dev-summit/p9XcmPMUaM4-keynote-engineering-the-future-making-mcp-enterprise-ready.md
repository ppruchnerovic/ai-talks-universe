...
duration_min: 5
published_at: 2025-10-09T13:44:23Z
video_id: p9XcmPMUaM4
youtube_url: https://www.youtube.com/watch?v=p9XcmPMUaM4
tags: ["mcp", "model context protocol", "mcp dev summit", "mcp summit", "mcp ai"]
transcript: false
---

# [Keynote] Engineering the Future-Making MCP Enterprise Ready for Finance - Shawn Edwards, Bloomberg

**Shawn Edwards**

`MCP Dev Summit` · `MCP Dev Summit Europe 2025` · `2025` · `5 min`

`#mcp` `#model context protocol` `#mcp dev summit` `#mcp summit` `#mcp ai`

[Watch the recording](https://www.youtube.com/watch?v=p9XcmPMUaM4) · [Conference site](https://events.linuxfoundation.org/mcp-dev-summit-north-america/)

## Description

Engineering the Future-Making MCP Enterprise Ready for Finance
...
Shawn is Vice Chairman of Latino U College Access (LUCA), a nonprofit that helps Latino youth enroll and succeed in college.
