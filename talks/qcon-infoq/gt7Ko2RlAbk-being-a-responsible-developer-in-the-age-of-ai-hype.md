...
`#Artificial Intelligence` `#Machine Learning` `#Data Engineering` `#InfoQ Dev Summit` `#InfoQ` `#transcript` `#Large Language Models` `#LLMs`

[Watch the recording](https://www.youtube.com/watch?v=gt7Ko2RlAbk) · [Conference site](https://qconferences.com/)

## Description

Video with transcript included on InfoQ: https://bit.ly/4cYYwz5
