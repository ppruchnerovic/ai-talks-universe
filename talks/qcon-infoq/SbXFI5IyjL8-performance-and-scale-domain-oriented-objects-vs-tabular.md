...
`#Artificial Intelligence` `#Machine Learning` `#Data Engineering` `#Data Analysis` `#Database` `#InfoQ` `#QCon` `#Transcript`

[Watch the recording](https://www.youtube.com/watch?v=SbXFI5IyjL8) · [Conference site](https://qconferences.com/)
...
----------------------------------------------------------------------------------------------------
Video with transcript included on InfoQ: https://bit.ly/3uWixFP
