...
`QCon / InfoQ Dev Summit` · `InfoQ` · `2023` · `34 min`

`#AI` `#Large Language Models` `#OpenAI` `#ChatGPT`

[Watch the recording](https://www.youtube.com/watch?v=lj5NjKHuFlo) · [Conference site](https://qconferences.com/)
