...
`#Software Development` `#CPU` `#GPU` `#Performance` `#InfoQ` `#QCon London` `#Transcript`

[Watch the recording](https://www.youtube.com/watch?v=CogYq8oTg6o) · [Conference site](https://qconferences.com/)

## Description

Video with transcript included on InfoQ: https://bit.ly/4fea03g
