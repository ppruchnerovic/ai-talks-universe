...
slug: infoq-software-architecture-design-trends-2023
...
`QCon / InfoQ Dev Summit` · `InfoQ` · `2023` · `40 min`

`#InfoQ Trends Reports` `#Architecture & Design` `#ChatGPT` `#WebAssembley` `#Blockchain`

[Watch the recording](https://www.youtube.com/watch?v=CKpxd3FBnqo) · [Conference site](https://qconferences.com/)
