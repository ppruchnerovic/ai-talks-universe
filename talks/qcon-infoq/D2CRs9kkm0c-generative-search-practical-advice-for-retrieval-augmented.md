...
`#Artificial Intelligence` `#Machine Learning` `#Data Engineering` `#RAG` `#LLMs` `#Retrieval Augmented generation` `#Large Language Models` `#InfoQ` `#QCon San Francisco` `#Transcript`

[Watch the recording](https://www.youtube.com/watch?v=D2CRs9kkm0c) · [Conference site](https://qconferences.com/)
...
------------------------------------------------------------------------------------------
Video with transcript included on InfoQ: https://bit.ly/46C95pE
