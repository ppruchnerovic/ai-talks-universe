...
`#AI` `#Large Language Models` `#Security` `#OWASP` `#InfoQ Podcasts` `#Software Development`

[Watch the recording](https://www.youtube.com/watch?v=TTZuUlZcFhc) · [Conference site](https://qconferences.com/)
