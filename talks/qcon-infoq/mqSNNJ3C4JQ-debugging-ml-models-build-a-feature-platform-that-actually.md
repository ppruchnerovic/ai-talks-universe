...
`#Feature Platform` `#ML` `#Machine Learning` `#MLOps` `#Software Architecture` `#AI` `#Artificial Intelligence` `#Scalability` `#Performance` `#Low Latency` `#Apache Flink` `#InfoQ` `#QCon London` `#Transcript`

[Watch the recording](https://www.youtube.com/watch?v=mqSNNJ3C4JQ) · [Conference site](https://qconferences.com/)
