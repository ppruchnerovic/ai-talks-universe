...
`#Software Architecture` `#InfoQ Dev Summit` `#Systems Thinking` `#Multi-Agent Systems` `#QCon` `#InfoQ` `#Transcript` `#Design Systems` `#Best Practices` `#AI Agents` `#Web Development` `#Artificial Intelligence`

[Watch the recording](https://www.youtube.com/watch?v=LxMaxrOfe1M) · [Conference site](https://qconferences.com/)
