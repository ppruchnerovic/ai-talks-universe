...
channel: null
duration_min: 53
published_at: 2025-01-13T08:38:23Z
video_id: QCpyyAcwsKk
...
`QCon / InfoQ Dev Summit` · `InfoQ` · `2025` · `53 min`

`#Software Architecture` `#Artificial Intelligence` `#InfoQ` `#InfoQ Dev Summit` `#Transcript`

[Watch the recording](https://www.youtube.com/watch?v=QCpyyAcwsKk) · [Conference site](https://qconferences.com/)

## Description

Video with transcript included on InfoQ: https://bit.ly/4289Kij
