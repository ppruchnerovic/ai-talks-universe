---
id: ot_lOcBCaH4
title: "Making Moves with Arrow Data: Introducing Arrow Database Connectivity (ADBC) | Voltron Data"
slug: making-moves-with-arrow-data-introducing-arrow-database
...
`AI Council (formerly Data Council)` · `Data Council / AI Council` · `2023` · `30 min`

`#apache arrow` `#data API` `#SQL` `#data engineering` `#infrastructure`

[Watch the recording](https://www.youtube.com/watch?v=ot_lOcBCaH4) · [Conference site](https://www.aicouncil.com/)
