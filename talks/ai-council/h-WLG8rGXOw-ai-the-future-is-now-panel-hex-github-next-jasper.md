---
id: h-WLG8rGXOw
title: "AI The Future is Now | Panel: Hex, GitHub Next, Jasper, Databricks, Insight Partners"
slug: ai-the-future-is-now-panel-hex-github-next-jasper
...
`AI Council (formerly Data Council)` · `Data Council / AI Council` · `2023` · `47 min`

`#Artificial intelligence` `#AI` `#ChatGPT` `#github` `#data visualization`

[Watch the recording](https://www.youtube.com/watch?v=h-WLG8rGXOw) · [Conference site](https://www.aicouncil.com/)
