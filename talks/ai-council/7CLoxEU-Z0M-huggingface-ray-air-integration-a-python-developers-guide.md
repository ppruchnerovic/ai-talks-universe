---
id: 7CLoxEU-Z0M
title: "HuggingFace + Ray AIR Integration: A Python Developer’s Guide to Scaling Transformers | AnyScale"
slug: huggingface-ray-air-integration-a-python-developers-guide
...
`#Python` `#opensource` `#machine learning` `#Ray` `#AI`

[Watch the recording](https://www.youtube.com/watch?v=7CLoxEU-Z0M) · [Conference site](https://www.aicouncil.com/)
