---
id: mQPWxgaNU5Q
title: "Continuous Data Pipeline for Real time Benchmarking & Data Set Augmentation | Teleskope"
...
`AI Council (formerly Data Council)` · `Data Council / AI Council` · `2023` · `15 min`

`#benchmarking` `#analytics` `#data set`

[Watch the recording](https://www.youtube.com/watch?v=mQPWxgaNU5Q) · [Conference site](https://www.aicouncil.com/)
