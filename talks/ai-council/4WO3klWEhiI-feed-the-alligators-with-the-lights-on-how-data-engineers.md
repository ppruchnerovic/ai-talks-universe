---
id: 4WO3klWEhiI
title: "Feed The Alligators With the Lights On: How Data Engineers Can See Who Really Uses Data | Stemma"
...
`#data engineering` `#data catalog` `#open source` `#query logs` `#API` `#metadata management`

[Watch the recording](https://www.youtube.com/watch?v=4WO3klWEhiI) · [Conference site](https://www.aicouncil.com/)
