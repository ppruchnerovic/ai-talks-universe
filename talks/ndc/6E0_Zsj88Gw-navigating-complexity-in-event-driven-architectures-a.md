...
slug: navigating-complexity-in-event-driven-architectures-a
conference: ndc
...
`NDC Conferences` · `NDC` · `2025` · `52 min`

`#David Boyne` `#Architecture` `#Microservices` `#NDC` `#Conferences` `#2025` `#Live` `#Fun` `#Copenhagen` `#DDD` `#Domain-Driven Design` `#Design` `#Domain` `#Driven`

[Watch the recording](https://www.youtube.com/watch?v=6E0_Zsj88Gw) · [Conference site](https://ndcconferences.com/)
