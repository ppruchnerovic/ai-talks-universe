...
# GPT-4 vs Starcraft II – Strategic Decision Making using Large Language Models - Alan Smith

**Alan Smith**

`NDC Conferences` · `NDC` · `2025` · `59 min`

`#AI` `#Fun` `#GPT-4` `#NDC` `#Conferences` `#2025` `#Live` `#Oslo` `#Norway` `#Alan Smith`

[Watch the recording](https://www.youtube.com/watch?v=VsheJ7Lz8aY) · [Conference site](https://ndcconferences.com/)
