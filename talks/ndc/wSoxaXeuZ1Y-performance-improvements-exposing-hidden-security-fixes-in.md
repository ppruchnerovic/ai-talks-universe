...
`NDC Conferences` · `NDC` · `2025` · `16 min`

`#Agile` `#People` `#AI` `#Machine Learning` `#Security` `#Fun` `#GenAI` `#IoT` `#NDC` `#Conferences` `#2025` `#Live` `#Oslo` `#Norway` `#Lightning Talks` `#Mackenzie Jackson`

[Watch the recording](https://www.youtube.com/watch?v=wSoxaXeuZ1Y) · [Conference site](https://ndcconferences.com/)

## Description

Performance improvements' and other lies: exposing hidden security fixes in Open Source - Mackenzie Jackson
