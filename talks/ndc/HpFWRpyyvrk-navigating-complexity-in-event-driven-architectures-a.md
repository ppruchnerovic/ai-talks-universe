...
`#DDD` `#Architecture` `#Microservices` `#Domain Driven Design` `#NDC` `#Conferences` `#2025` `#Live` `#Fun` `#London` `#David Boyne`

[Watch the recording](https://www.youtube.com/watch?v=HpFWRpyyvrk) · [Conference site](https://ndcconferences.com/)
