...
# Using GenAI on and inside your code, what could possibly go wrong? - Niels Tanis - NDC Copenhagen

**Niels Tanis**

`NDC Conferences` · `NDC` · `2025` · `55 min`

`#Security` `#GenAI` `#NDC` `#Conferences` `#LLM` `#Fun` `#Copenhagen` `#Live` `#Niels Tanis` `#Software`

[Watch the recording](https://www.youtube.com/watch?v=eaUL-V58woU) · [Conference site](https://ndcconferences.com/)
