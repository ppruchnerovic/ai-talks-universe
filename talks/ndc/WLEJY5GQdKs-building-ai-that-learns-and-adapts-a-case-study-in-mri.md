...
# Building AI That Learns and Adapts: A Case Study in MRI Diagnostics - Agata Chudzińska - NDC Oslo

**Speaker not identified**

`NDC Conferences` · `NDC` · `2025` · `50 min`

`#AI` `#Architecture` `#Machine Learning` `#NDC` `#Conferences` `#2025` `#Live` `#Fun` `#Oslo` `#Norway` `#Agata Chudzińska`

[Watch the recording](https://www.youtube.com/watch?v=WLEJY5GQdKs) · [Conference site](https://ndcconferences.com/)
