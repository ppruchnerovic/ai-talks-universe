...
# Old to Gold: How to Modernize Your Legacy ASP.NET Apps Gradually - Jonathan J Tower - NDC Melbourne

**Jonathan J Tower**

`NDC Conferences` · `NDC` · `2025` · `60 min`

`#.NET` `#Architecture` `#YARP` `#ASP.NET` `#ASP.NET Core` `#NDC` `#Conferences` `#2025` `#Live` `#Fun` `#Melbourne` `#Australia` `#Jonathan J Tower`

[Watch the recording](https://www.youtube.com/watch?v=fwKZIaEU7_Y) · [Conference site](https://ndcconferences.com/)
