...
# AI War Stories: Real world learnings delivering enterprise AI solutions - Adam Stephenson

**Adam Stephenson**

`NDC Conferences` · `NDC` · `2025` · `56 min`

`#AI` `#.NET` `#Architecture` `#NDC` `#Conferences` `#Melbourne` `#Australia` `#Fun` `#Live` `#2025` `#Adam Stephenson`

[Watch the recording](https://www.youtube.com/watch?v=KTbeNNUOmVI) · [Conference site](https://ndcconferences.com/)
