...
`#AI` `#C Code` `#UI` `#LLM` `#Chat GPT` `#NDC` `#Conferences` `#2025` `#Live` `#Fun` `#London`

[Watch the recording](https://www.youtube.com/watch?v=awztkr8n0AA) · [Conference site](https://ndcconferences.com/)
