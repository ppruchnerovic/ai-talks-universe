...
`#AI` `#Ethics` `#Machine Learning` `#GenAI` `#ML` `#LLM` `#NDC` `#Conferences` `#2025` `#Live` `#Fun` `#Copenhagen` `#Lucía Conde-Moreno`

[Watch the recording](https://www.youtube.com/watch?v=ekqXHwXbkjU) · [Conference site](https://ndcconferences.com/)
