...
`#camlis` `#camlis2018` `#bonware`

[Watch the recording](https://www.youtube.com/watch?v=1np-YB9oBjY) · [Conference site](https://www.camlis.org/)

## Description

CAMLIS 2018, Shanchieh (Jay) Yang, Rochester Institute of Technology
Anticipatory Cyber Defense via Predictive Analytics, Machines Learning and Simulation (slides: https://www.camlis.org/shanchieh-jay-yang/)
