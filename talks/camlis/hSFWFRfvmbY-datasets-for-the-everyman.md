...
channel: "CAMLIS"
duration_min: 26
published_at: 2018-11-16T17:23:14Z
video_id: hSFWFRfvmbY
...
`CAMLIS` · `CAMLIS` · `2018` · `26 min`

`#camlis` `#camlis2018`

[Watch the recording](https://www.youtube.com/watch?v=hSFWFRfvmbY) · [Conference site](https://www.camlis.org/)

## Description

CAMLIS 2018, Ryan Kovar, Splunk
Datasets for the Everyman (slides: https://www.camlis.org/ryan-kovar/)
