---
id: Ox0fGfpLPuc
title: "Anthony Annunziata, IBM: Open Source AI: Status, Opportunities, and Challenges"
...
duration_min: 11
published_at: 2025-05-23T18:29:54Z
video_id: Ox0fGfpLPuc
url: https://www.youtube.com/watch?v=Ox0fGfpLPuc
youtube_url: https://www.youtube.com/watch?v=Ox0fGfpLPuc
tags: []
topics: ["Enterprise adoption & strategy"]
transcript: false
---

# Anthony Annunziata, IBM: Open Source AI: Status, Opportunities, and Challenges

**Speaker not identified**

`The AI Conference` · `The AI Conference` · `2025` · `11 min`

[Watch the recording](https://www.youtube.com/watch?v=Ox0fGfpLPuc) · [Conference site](https://aiconference.com/)

## Description

Anthony Annunziata, Director of AI Open Innovation, IBM

Open Source AI:
Status, Opportunities, and Challenges from the Enterprise Perspective
