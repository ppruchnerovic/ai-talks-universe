---
id: eBbkbkl2oME
title: "Cooking With The Semantic Kernel, Alex Chao, Product Manager, Microsoft"
...
video_id: eBbkbkl2oME
url: https://www.youtube.com/watch?v=eBbkbkl2oME
youtube_url: https://www.youtube.com/watch?v=eBbkbkl2oME
tags: []
topics: ["Classic ML & data science", "Enterprise adoption & strategy", "Multimodal, vision, speech & robotics", "Prompting & context engineering", "RAG, retrieval & knowledge", "Science, healthcare & applied ML"]
transcript: false
---

# Cooking With The Semantic Kernel, Alex Chao, Product Manager, Microsoft

**Speaker not identified**

`The AI Conference` · `The AI Conference` · `2023` · `30 min`

[Watch the recording](https://www.youtube.com/watch?v=eBbkbkl2oME) · [Conference site](https://aiconference.com/)
