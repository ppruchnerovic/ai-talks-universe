---
id: xeFPr1bBhj8
title: "João (Joe) Moura, Founder, CrewAI: Building an AI-Driven Company with Agents"
...
duration_min: 30
published_at: 2025-08-19T03:29:51Z
...
# João (Joe) Moura, Founder, CrewAI: Building an AI-Driven Company with Agents

**Speaker not identified**

`The AI Conference` · `The AI Conference` · `2025` · `30 min`

[Watch the recording](https://www.youtube.com/watch?v=xeFPr1bBhj8) · [Conference site](https://aiconference.com/)

## Description

João (Joe) Moura, Founder, CrewAI
