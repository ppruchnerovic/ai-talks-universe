---
id: 2KuqDo2oHdE
title: "From LLMs to DSLMs: A Practical Solution for Faster, More Resource-Efficient AI, Anoop Duwar"
...
video_id: 2KuqDo2oHdE
youtube_url: https://www.youtube.com/watch?v=2KuqDo2oHdE
tags: []
transcript: false
---

# From LLMs to DSLMs: A Practical Solution for Faster, More Resource-Efficient AI, Anoop Duwar

**Speaker not identified**

`The AI Conference` · `The AI Conference` · `2023` · `11 min`

[Watch the recording](https://www.youtube.com/watch?v=2KuqDo2oHdE) · [Conference site](https://aiconference.com/)
