---
id: am7eqeZ6qWI
title: "Generative AI, Enterprise LLMs And Path To Trillion Parameter Models, SambaNova Systems"
...
# Generative AI, Enterprise LLMs And Path To Trillion Parameter Models, SambaNova Systems

**Speaker not identified**

`The AI Conference` · `The AI Conference` · `2023` · `16 min`

[Watch the recording](https://www.youtube.com/watch?v=am7eqeZ6qWI) · [Conference site](https://aiconference.com/)

## Description

Generative AI, Enterprise LLMs And Path To Trillion Parameter Models, Urmish Thakker, SambaNova Systems
