---
id: Z9xVmzkWgQk
title: "Aurimas Griciūnas, Neptune.AI: Observability in LLMOps pipeline - different levels of scale"
...
duration_min: 29
published_at: 2025-06-25T20:04:59Z
video_id: Z9xVmzkWgQk
...
# Aurimas Griciūnas, Neptune.AI: Observability in LLMOps pipeline - different levels of scale

**Speaker not identified**

`The AI Conference` · `The AI Conference` · `2025` · `29 min`

[Watch the recording](https://www.youtube.com/watch?v=Z9xVmzkWgQk) · [Conference site](https://aiconference.com/)

## Description

Aurimas Griciūnas, Chief Product Officer, Neptune.AI
