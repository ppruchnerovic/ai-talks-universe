---
id: sGgSzVS3DM4
title: "Sandeep Krishnamurthy, Databricks: Pre-training large language models:Lessons from the trenches"
...
duration_min: 26
published_at: 2025-05-14T21:48:55Z
video_id: sGgSzVS3DM4
...
# Sandeep Krishnamurthy, Databricks: Pre-training large language models:Lessons from the trenches

**Speaker not identified**

`The AI Conference` · `The AI Conference` · `2025` · `26 min`

[Watch the recording](https://www.youtube.com/watch?v=sGgSzVS3DM4) · [Conference site](https://aiconference.com/)

## Description

Sandeep Krishnamurthy, Engineering Director, Databricks

Pre-training large language models:Lessons from the trenches
