---
id: f3VYZ-6iylM
title: "Exploring AI Security: Red Teaming & Offensive Agents with Ads | GenAI Security Ep.3"
...
# Exploring AI Security: Red Teaming & Offensive Agents with Ads | GenAI Security Ep.3

**Speaker not identified**

`OWASP GenAI Security Project` · `OWASP GenAI Security` · `2025` · `32 min`

`#agent ai` `#red teaming` `#owasp` `#top 10 for llm applications and generative ai` `#generative ai` `#Aubrey King` `#Ads Dawson` `#offensive agents` `#chatbot` `#ai security` `#GenAI Security`

[Watch the recording](https://www.youtube.com/watch?v=f3VYZ-6iylM) · [Conference site](https://genai.owasp.org/)
