---
id: q7b7gxp_2Zw
title: "Sandboxing AI Models with Dyana & OWASP Top 10 for LLM Apps - Ep.4"
...
duration_min: 23
published_at: 2025-03-05T21:18:47Z
video_id: q7b7gxp_2Zw
...
# Sandboxing AI Models with Dyana & OWASP Top 10 for LLM Apps - Ep.4

**Speaker not identified**

`OWASP GenAI Security Project` · `OWASP GenAI Security` · `2025` · `23 min`

[Watch the recording](https://www.youtube.com/watch?v=q7b7gxp_2Zw) · [Conference site](https://genai.owasp.org/)
