---
id: rgAUY9MkCkk
title: "Lightning Talk: Open Source GenAI: A Community-Powered Future - Ofer Hermoni"
...
video_id: rgAUY9MkCkk
url: https://www.youtube.com/watch?v=rgAUY9MkCkk
youtube_url: https://www.youtube.com/watch?v=rgAUY9MkCkk
tags: []
topics: []
transcript: false
---

# Lightning Talk: Open Source GenAI: A Community-Powered Future - Ofer Hermoni

**Ofer Hermoni**

`AI_dev / Open Source Summit (Linux Foundation)` · `AI_dev Europe 2024` · `2024` · `10 min`

[Watch the recording](https://www.youtube.com/watch?v=rgAUY9MkCkk) · [Conference site](https://events.linuxfoundation.org/ai-dev-europe/)
