---
id: 0liy99DB8Tg
title: "EVE: An Open Source Earth Science LLM for Researc... Àlex R. Atrio, Vijayasri Iyer & Marcello Politi"
...
# EVE: An Open Source Earth Science LLM for Researc... Àlex R. Atrio, Vijayasri Iyer & Marcello Politi

**Speaker not identified**

`AI_dev / Open Source Summit (Linux Foundation)` · `AI_dev Europe 2025` · `2025` · `34 min`

[Watch the recording](https://www.youtube.com/watch?v=0liy99DB8Tg) · [Conference site](https://events.linuxfoundation.org/ai-dev-europe/)
...
EVE: An Open Source Earth Science LLM for Researchers, Policymakers, and the Public - Àlex R. Atrio, Vijayasri Iyer & Marcello Politi, Pi School
