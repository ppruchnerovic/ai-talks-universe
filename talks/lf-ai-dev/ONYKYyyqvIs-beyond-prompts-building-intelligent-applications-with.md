---
id: ONYKYyyqvIs
title: "Beyond Prompts: Building Intelligent Applications With Genkit and the Model Context... Peter Friese"
slug: beyond-prompts-building-intelligent-applications-with
...
# Beyond Prompts: Building Intelligent Applications With Genkit and the Model Context... Peter Friese

**Speaker not identified**

`AI_dev / Open Source Summit (Linux Foundation)` · `AI_dev Europe 2025` · `2025` · `37 min`

[Watch the recording](https://www.youtube.com/watch?v=ONYKYyyqvIs) · [Conference site](https://events.linuxfoundation.org/ai-dev-europe/)
