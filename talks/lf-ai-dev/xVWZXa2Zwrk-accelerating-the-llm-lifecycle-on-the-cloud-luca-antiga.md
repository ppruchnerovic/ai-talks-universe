---
id: xVWZXa2Zwrk
title: "Accelerating the LLM Lifecycle on the Cloud - Luca Antiga, Lightning AI"
...
# Accelerating the LLM Lifecycle on the Cloud - Luca Antiga, Lightning AI

**Luca Antiga**

`AI_dev / Open Source Summit (Linux Foundation)` · `AI_dev Europe 2024` · `2024` · `33 min`

[Watch the recording](https://www.youtube.com/watch?v=xVWZXa2Zwrk) · [Conference site](https://events.linuxfoundation.org/ai-dev-europe/)
