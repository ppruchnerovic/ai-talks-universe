---
id: IBBeLNgGIIo
title: "Hugging Face Accelerate: Making Device-Agnostic ML Training and Inference Easy... - Zachary Mueller"
slug: hugging-face-accelerate-making-device-agnostic-ml-training
conference: lf-ai-dev
conference_name: "AI_dev / Open Source Summit (Linux Foundation)"
category: "Software dev with AI tracks"
edition: "AI_dev Europe 2024"
year: 2024
speakers: ["Zachary Mueller"]
...
`AI_dev / Open Source Summit (Linux Foundation)` · `AI_dev Europe 2024` · `2024` · `23 min`

[Watch the recording](https://www.youtube.com/watch?v=IBBeLNgGIIo) · [Conference site](https://events.linuxfoundation.org/ai-dev-europe/)
