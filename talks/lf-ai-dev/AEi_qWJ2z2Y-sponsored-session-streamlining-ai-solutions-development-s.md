---
id: AEi_qWJ2z2Y
title: "Sponsored Session: Streamlining AI Solutions Development: S... Shinsuke Tashiro & Munehiro Shimomura"
slug: sponsored-session-streamlining-ai-solutions-development-s
...
duration_min: 38
published_at: 2025-09-05T19:42:43Z
video_id: AEi_qWJ2z2Y
url: https://www.youtube.com/watch?v=AEi_qWJ2z2Y
youtube_url: https://www.youtube.com/watch?v=AEi_qWJ2z2Y
tags: []
topics: ["Inference, serving & GPU infra"]
transcript: false
---

# Sponsored Session: Streamlining AI Solutions Development: S... Shinsuke Tashiro & Munehiro Shimomura

**Speaker not identified**

`AI_dev / Open Source Summit (Linux Foundation)` · `Open Source Summit EU 2025` · `2025` · `38 min`

[Watch the recording](https://www.youtube.com/watch?v=AEi_qWJ2z2Y) · [Conference site](https://events.linuxfoundation.org/ai-dev-europe/)
...
Sponsored Session: Streamlining AI Solutions Development: Seamless Development from Device to Cloud Harnessing WebAssembly on the Edge - Shinsuke Tashiro & Munehiro Shimomura, Sony Semiconductor Solutions Corporation
...
- Deploy Wasm applications on the edge with simple command
