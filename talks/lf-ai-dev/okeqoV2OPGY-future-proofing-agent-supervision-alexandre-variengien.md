---
id: okeqoV2OPGY
title: "Future-Proofing Agent Supervision - Alexandre Variengien & Diego Dorn, EffiSciences"
...
**Alexandre Variengien, Diego Dorn**

`AI_dev / Open Source Summit (Linux Foundation)` · `AI_dev Europe 2024` · `2024` · `31 min`

[Watch the recording](https://www.youtube.com/watch?v=okeqoV2OPGY) · [Conference site](https://events.linuxfoundation.org/ai-dev-europe/)
