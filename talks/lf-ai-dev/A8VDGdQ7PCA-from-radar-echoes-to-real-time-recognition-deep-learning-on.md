---
id: A8VDGdQ7PCA
title: "From Radar Echoes To Real-Time Recognition: Deep Learning on Another Planet -An Op... Viktor Somogyi"
...
video_id: A8VDGdQ7PCA
url: https://www.youtube.com/watch?v=A8VDGdQ7PCA
youtube_url: https://www.youtube.com/watch?v=A8VDGdQ7PCA
tags: []
topics: ["Classic ML & data science"]
transcript: false
---

# From Radar Echoes To Real-Time Recognition: Deep Learning on Another Planet -An Op... Viktor Somogyi

**Speaker not identified**

`AI_dev / Open Source Summit (Linux Foundation)` · `AI_dev Europe 2025` · `2025` · `31 min`

[Watch the recording](https://www.youtube.com/watch?v=A8VDGdQ7PCA) · [Conference site](https://events.linuxfoundation.org/ai-dev-europe/)
