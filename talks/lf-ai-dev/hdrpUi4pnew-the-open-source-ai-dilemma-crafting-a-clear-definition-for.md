---
id: hdrpUi4pnew
title: "The Open Source AI Dilemma: Crafting a Clear Definition for Open Source AI - Ofer Hermoni"
...
`AI_dev / Open Source Summit (Linux Foundation)` · `AI_dev Europe 2024` · `2024` · `37 min`

[Watch the recording](https://www.youtube.com/watch?v=hdrpUi4pnew) · [Conference site](https://events.linuxfoundation.org/ai-dev-europe/)
