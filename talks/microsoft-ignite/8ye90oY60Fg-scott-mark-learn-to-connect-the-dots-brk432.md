---
id: 8ye90oY60Fg
title: "Scott & Mark learn to connect the dots | BRK432"
slug: scott-mark-learn-to-connect-the-dots-brk432
...
`#BRK432` `#BRK432_v1` `#English (US)` `#Mark Russinovich` `#Migrate and modernize your estate` `#Scale with cloud and AI endpoints` `#Scott & Mark learn to connect the dots | BRK432` `#Scott Hanselman` `#Signature pass` `#Technical` `#f5n1` `#ignite` `#ignite 2025` `#microsoft` `#microsoft ignite` `#microsoft ignite 2025` `#ms ignite` `#ms ignite 2025` `#msft ignite` `#msft ignite 2025`

[Watch the recording](https://www.youtube.com/watch?v=8ye90oY60Fg) · [Conference site](https://ignite.microsoft.com/)

## Description

Join Scott Hanselman and Mark Russinovich as they trace computing’s evolution from the Altair 8800 to today’s cloud. In this live, demo-driven session, you’ll see how the humble toggle switch gave rise to REST APIs, why terminals are making a comeback, and how the architectural patterns of 1975 illuminate 2025’s biggest trends. Along the way, we’ll connect the dots from early personal computing to hyperscale platforms, highlighting how modern apps are built, scaled, and delivered in the cloud.
