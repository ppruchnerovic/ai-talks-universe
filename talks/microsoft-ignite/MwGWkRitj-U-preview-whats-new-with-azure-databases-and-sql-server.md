---
id: MwGWkRitj-U
title: "Preview: What’s new with Azure Databases and SQL Server | STUDIO32"
...
`#English (US)` `#Other` `#Preview: What’s new with Azure Databases and SQL Server | STUDIO32` `#STUDIO32` `#STUDIO32_v1` `#Shireesh Thota` `#f5n1` `#ignite` `#ignite 2025` `#microsoft` `#microsoft ignite` `#microsoft ignite 2025` `#ms ignite` `#ms ignite 2025` `#msft ignite` `#msft ignite 2025`

[Watch the recording](https://www.youtube.com/watch?v=MwGWkRitj-U) · [Conference site](https://ignite.microsoft.com/)
...
Chapters:
0:00 - Overview of Major Database Announcements
00:02:19 - Announcement 3: Azure DocumentDB – Open Source and Mongo-Compatible
00:03:26 - Summary of Four Major Database Announcements
00:06:04 - Discussion on open-source database strategy in Azure
00:08:55 - Introduction of DocumentDB as an Open Source Non-Relational Database
00:09:41 - Introduction to Microsoft Fabric and Integration of Databases
00:10:25 - Simplified and Autonomous Database Management in Fabric
00:12:52 - Discussion on simplifying data architecture using event-driven patterns
00:15:40 - Partner testimonials on how Azure accelerates modernization and migration
