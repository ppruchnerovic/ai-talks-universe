---
id: YZJCVtt0bwQ
title: "Build, modernize, and secure AKS workloads with Azure Linux | BRK144"
...
# Build, modernize, and secure AKS workloads with Azure Linux | BRK144

**Sudhanva Huruli, Dongha Paek**

`Microsoft Ignite` · `Ignite 2025` · `2025` · `33 min`

`#98fcc9ec-a822-4708-963c-54faaf346f29_Segment` `#BRK144` `#Build modernize and secure AKS workloads with Azure Linux | BRK144` `#Dongha Paek` `#English (US)` `#Migrate and modernize your estate` `#Migrate and modernize your estate:Azure Kubernetes Service (AKS)` `#Sudhanva Huruli` `#Technical` `#f5n1` `#ignite` `#ignite 2025` `#microsoft` `#microsoft ignite` `#microsoft ignite 2025` `#ms ignite` `#ms ignite 2025` `#msft ignite` `#msft ignite 2025`

[Watch the recording](https://www.youtube.com/watch?v=YZJCVtt0bwQ) · [Conference site](https://ignite.microsoft.com/)
...
BRK144 | English (US) | Migrate and modernize your estate, Azure Kubernetes Service (AKS)
...
Chapters:
0:00 - Development of CBL Mariner and Rebranding to Azure Linux
00:07:49 - Seamless migration from Ubuntu to Azure Linux without additional capacity
00:12:40 - Performance improvements through lightweight design and consistent updates
00:16:35 - Combining Normal and Sandbox Containers on Azure Linux Node
00:20:10 - Deep Dive into Kata Container Architecture on Azure Kubernetes Service
00:22:02 - Demonstration of Azure Linux with OS Guard and Security Features
00:27:12 - Integrity Policy Enforcement with IPE Kernel Module
00:28:22 - Azure Linux Roadmap: Upcoming Features and Enhancements
00:29:37 - Future Improvements: Enforcing SELinux, Minimizing Images, and GPU Support
