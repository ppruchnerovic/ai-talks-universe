---
id: HelG1r0GneA
title: "SQL Server 2025: The AI-ready enterprise database | BRK124"
...
duration_min: 45
published_at: 2025-11-20T10:39:16Z
video_id: HelG1r0GneA
...
**Sirjad Parakkat, Abhinav Tiwari, Bob Ward**

`Microsoft Ignite` · `Ignite 2025` · `2025` · `45 min`

`#054d2113-0a38-4fca-b701-b43f6e109fe7_Segment` `#Abhinav Tiwari` `#BRK124` `#Bob Ward` `#English (US)` `#Migrate and modernize your estate` `#SQL Server 2025: The AI-ready enterprise database | BRK124` `#Sirjad Parakkat` `#Technical` `#f5n1` `#ignite` `#ignite 2025` `#microsoft` `#microsoft ignite` `#microsoft ignite 2025` `#ms ignite` `#ms ignite 2025` `#msft ignite` `#msft ignite 2025`

[Watch the recording](https://www.youtube.com/watch?v=HelG1r0GneA) · [Conference site](https://ignite.microsoft.com/)
...
Chapters:
0:00 - Introduction and Celebration of SQL Server 2025 Launch
00:00:37 - Session Overview and Logistics Details
00:11:20 - Creating a vector index with parallelism support
00:17:40 - Customer case study introduction: Inviting Avante representative
00:22:11 - Avante shares AI-enabled product innovations powered by SQL Server 2025
00:23:26 - Announcement of New SQL AI Certification
00:24:12 - Introduction of JSON Native Data Type and Functions
00:33:07 - Prompt Programming with Copilot and T-SQL Integration
00:40:26 - Announcement of SQL Server Edition changes and expanded limits
