---
id: dXUy9evg1yo
title: "AI fine-tuning in Microsoft Foundry to make your agents unstoppable | BRK188"
...
**Alicia Frame, Ramachandra Kota, Omkar More**

`Microsoft Ignite` · `Ignite 2025` · `2025` · `45 min`

`#AI fine-tuning in Microsoft Foundry to make your agents unstoppable | BRK188` `#Alicia Frame` `#BRK188` `#English (US)` `#Innovate with Azure AI apps and agents` `#Innovate with Azure AI apps and agents:Microsoft Foundry` `#Omkar More` `#Ramachandra Kota` `#Technical` `#ddc42249-adc0-4966-ac20-b4fc58218a04_Segment` `#f5n1` `#ignite` `#ignite 2025` `#microsoft` `#microsoft ignite` `#microsoft ignite 2025` `#ms ignite` `#ms ignite 2025` `#msft ignite` `#msft ignite 2025`

[Watch the recording](https://www.youtube.com/watch?v=dXUy9evg1yo) · [Conference site](https://ignite.microsoft.com/)
...
BRK188 | English (US) | Innovate with Azure AI apps and agents, Microsoft Foundry
...
Chapters:
0:00 - Practical steps for fine tuning: choosing models, generating data, evaluating performance
00:06:00 - Announcement of synthetic data generation feature in Foundry for automatic training data creation
00:11:06 - Synthetic data generation using Swagger definitions and model selection
00:11:56 - Multi-agent collaboration for high-quality synthetic data creation
00:21:59 - Introduction to complex query handling example
00:24:30 - Demonstration of launching RFT in Foundry using GPT-5 and O4 Mini
00:32:04 - Overview of Navigator – AI-powered contract repository
00:34:24 - AI extraction insights – deriving key contract details and relationships
00:36:00 - Building scalable AI for processing millions of documents per day
