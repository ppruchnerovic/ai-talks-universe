---
id: MWid8VX6PZ4
title: "Azure AI Infra updates to power frontier and enterprise workloads | BRK179"
...
`#Azure AI Infra updates to power frontier and enterprise workloads | BRK179` `#BRK179` `#English (US)` `#Migrate and modernize your estate` `#Technical` `#f5n1` `#ignite` `#ignite 2025` `#microsoft` `#microsoft ignite` `#microsoft ignite 2025` `#ms ignite` `#ms ignite 2025` `#msft ignite` `#msft ignite 2025`

[Watch the recording](https://www.youtube.com/watch?v=MWid8VX6PZ4) · [Conference site](https://ignite.microsoft.com/)
...
Chapters:
0:00 - Session format: discussion, demos, and Q&A
00:03:24 - Introduction to major announcements—Work IQ and new features
00:11:34 - Comparison between Work IQ and connectors as data access methods
00:16:03 - Demonstration of M365 Copilot mobile app and Work IQ interaction
00:23:21 - Demonstration: Creating a Discounted Cash Flow (DCF) model using Agent Mode in Excel
00:24:55 - Demonstration: Agent Mode in Word for automated content gathering and summarization
00:35:40 - Explanation of agent context transfer and industry state
00:36:16 - Integration of Anthropic models for improved agent orchestration
00:42:55 - Announcement of upcoming developer summit and closing remarks
