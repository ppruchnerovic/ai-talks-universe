---
id: oay_SnZDtwg
title: "Grow your business with Microsoft AI Cloud Partner Program | BRK347"
...
duration_min: 38
published_at: 2024-11-27T13:15:22Z
video_id: oay_SnZDtwg
...
# Grow your business with Microsoft AI Cloud Partner Program | BRK347

**Dan Rippey, Andrew Smith**

`Microsoft Ignite` · `Ignite 2024` · `2024` · `38 min`

`#Andrew Smith` `#BRK347` `#Breakout` `#Dan Rippey` `#English (US)` `#Foundational (100)` `#Grow your business with Microsoft AI Cloud Partner Program | BRK347` `#Partner Business` `#Partner Program` `#Version v4` `#ignite` `#ignite 2024` `#m6x0` `#microsoft` `#microsoft ignite` `#microsoft ignite 2024` `#ms ignite` `#ms ignite 2024` `#msft ignite` `#msft ignite 2024`

[Watch the recording](https://www.youtube.com/watch?v=oay_SnZDtwg) · [Conference site](https://ignite.microsoft.com/)
...
* https://partner.microsoft.com/en-us/blog/article/innovate-with-partner-benefits
* https://partner.microsoft.com/blog/article/microsoft-partner-skilling
* https://partner.microsoft.com/connect/case-studies#/
...
BRK347 | English (US) | Partner Program
