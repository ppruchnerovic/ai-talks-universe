---
id: Y17b0rJ_psk
title: "Modern data modern apps: Innovation with Microsoft Databases | BRK134"
...
`#BRK134` `#BRK134_v2` `#Charles Feddersen` `#English (US)` `#Kirill Gavrylyuk` `#Modern data modern apps: Innovation with Microsoft Databases | BRK134` `#Priya Sathy` `#Shireesh Thota` `#Shivakumar Vaithyanathan` `#Signature pass` `#Technical` `#Unify your data platform` `#Unify your data platform:Azure CosmosDB` `#Unify your data platform:Azure SQL` `#f5n1` `#ignite` `#ignite 2025` `#microsoft` `#microsoft ignite` `#microsoft ignite 2025` `#ms ignite` `#ms ignite 2025` `#msft ignite` `#msft ignite 2025`

[Watch the recording](https://www.youtube.com/watch?v=Y17b0rJ_psk) · [Conference site](https://ignite.microsoft.com/)
...
BRK134 | English (US) | Unify your data platform, Azure CosmosDB, Azure SQL
...
Chapters:
0:00 - New Features in SQL Server 2025: AI, Semantic Search, Vector Types, and Security
00:18:25 - Introduction of SQL Con — a new dedicated SQL data conference launching in 2026
00:20:07 - Transition to PostgreSQL discussion — community involvement and open-source contributions by Microsoft
00:25:02 - Horizon DB demo: provisioning in VS Code, AI integration with vector indexing and embeddings
00:26:22 - Using GPT-5 for AI-powered data extraction in SQL
00:35:15 - DocumentDB multi-cloud demo showing global consistency and failover
00:41:14 - Customer spotlight introduction: Adobe VP of Platform AI Engineering joins the stage
00:49:54 - Session recap: introducing four major database innovations including SQL 2025, Horizon DB, and Fabric integration
00:50:49 - Closing remarks: Gratitude and encouragement to explore detailed sessions and innovations
