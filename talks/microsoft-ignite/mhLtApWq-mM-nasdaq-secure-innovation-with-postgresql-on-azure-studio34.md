---
id: mhLtApWq-mM
title: "Nasdaq: Secure Innovation with PostgreSQL on Azure | STUDIO34"
...
`#Charles Feddersen` `#English (US)` `#Mohsin Shafqat` `#Nasdaq: Secure Innovation with PostgreSQL on Azure | STUDIO34` `#Other` `#STUDIO34` `#STUDIO34_v1` `#f5n1` `#ignite` `#ignite 2025` `#microsoft` `#microsoft ignite` `#microsoft ignite 2025` `#ms ignite` `#ms ignite 2025` `#msft ignite` `#msft ignite 2025`

[Watch the recording](https://www.youtube.com/watch?v=mhLtApWq-mM) · [Conference site](https://ignite.microsoft.com/)
...
Chapters:
0:00 - Discussion on NASDAQ’s Data Diversity and Governance Solutions
00:03:57 - Introduction to Top-Down Learning and BoardVantage's Role
00:05:25 - Deployment and Data Separation Using Foundry Models
00:06:47 - Importance of Data Security for BoardVantage Customers
00:08:42 - Built-in Azure security and private endpoints
00:09:39 - Explanation of vector databases and their capabilities
00:10:55 - Semantic search and performance advantages of vector indexing
00:12:45 - Discussion on HorizonDB’s potential for enterprise use cases
00:14:03 - Improving context accuracy using document intelligence
