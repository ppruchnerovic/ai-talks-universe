---
id: W2qusd0gtTE
title: "Move fast save more with MongoDB-compatible workloads on DocumentDB | BRK132"
...
`#1680cad3-79c9-4049-a318-848db980c11b_Segment` `#BRK132` `#English (US)` `#Gurvinder Singh` `#Khelan Modi` `#Move fast save more with MongoDB-compatible workloads on DocumentDB | BRK132` `#Patty Chow` `#Technical` `#Unify your data platform` `#f5n1` `#ignite` `#ignite 2025` `#microsoft` `#microsoft ignite` `#microsoft ignite 2025` `#ms ignite` `#ms ignite 2025` `#msft ignite` `#msft ignite 2025`

[Watch the recording](https://www.youtube.com/watch?v=W2qusd0gtTE) · [Conference site](https://ignite.microsoft.com/)
...
Chapters:
0:00 - Introduction to Open Source DocumentDB and Portability Across Clouds
00:03:42 - Demo: LLM-Based Index Advisor and Query Optimization Using AI
00:10:06 - Migrating collections such as Sample Restaurants database
00:11:00 - Verifying data transfer using VS Code extension
00:11:37 - Introducing AI-ready features: LLM-based Index Advisor and KNN support
00:19:56 - Overview of Cosmos AI Graph architecture and its components
00:25:17 - Examples demonstrating deterministic vs. semantic discovery queries and hybrid search
00:29:50 - Explanation of Multi-Cloud and Hybrid Cloud Capabilities
00:33:04 - Session Wrap-Up and Getting Started Options
